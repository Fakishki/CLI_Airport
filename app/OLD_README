[README linked from this repo](https://github.com/learn-co-curriculum/python-p3-cli-project-template)
...
- [Markdown Cheat Sheet](https://www.markdownguide.org/cheat-sheet/)# CLI_Airport
